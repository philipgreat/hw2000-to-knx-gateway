...
- [tree.lua](+tree.lua): draws a recursive tree
- [trajectory.lua](+trajectory.lua): plots a trajectory for a system of equations
- [graph.lua](+graph.lua): draws an arbitrary graph
]]